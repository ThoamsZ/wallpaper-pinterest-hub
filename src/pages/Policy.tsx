    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <Card className="max-w-4xl mx-auto p-6 space-y-8 mb-8">
        <div className="prose prose-sm max-w-none">
          ...
          <p className="mt-4">
            Welcome to xxWallpaper (hereinafter referred to as "the Website" or "we"). By accessing or using the Website, you agree to be bound by these Terms of Use (hereinafter referred to as "Terms"). If you do not agree to these Terms, please do not use the Website.
          </p>

          <h2 className="text-2xl font-semibold mt-6">1. Service Overview</h2>
          <p>
            xxWallpaper provides users with tools and services for generating, editing, and sharing images. Specific features and services may be updated or modified at our discretion.
          </p>

          <h2 className="text-2xl font-semibold mt-6">2. Eligibility</h2>
          <p>
            You must be at least 13 years old (or the minimum age of digital consent in your jurisdiction) to use the Website. If you are under the legal age, you may only use the Website with the consent and supervision of a parent or guardian.
          </p>
          ...
          <h2 className="text-2xl font-semibold mt-6">5. Disclaimer of Warranties</h2>
          ...
          <h2 className="text-2xl font-semibold mt-6">Copyright Infringement Notice</h2>
          ...
          <p>Email: xxwallpaperofficial@gmail.com</p>
          ...
          <h1 className="text-3xl font-bold mt-12 mb-4">Privacy Policy</h1>
          <p className="text-sm text-muted-foreground">
            Effective Date: October 26, 2023<br />
            Last Updated: October 26, 2023
          </p>

          <p className="mt-4">Your privacy is important to us. This Privacy Policy explains how xxWallpaper collects, uses, stores, and protects your personal information.</p>
          ...
          <p>If you have any questions about these Terms, the Copyright Infringement Notice, or the Privacy Policy, please contact us at xxwallpaperofficial@gmail.com.</p>
        </div>
      </Card>
    </div>
  );
